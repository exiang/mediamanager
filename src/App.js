...
function App() {
  ...
  return (
    <div className="App">
      <BrowserRouter>
      <nav className="bg-gray-800 text-white border-gray-200 px-2 sm:px-4 py-2.5  dark:bg-gray-900">
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          <a href="" className="flex items-center">
              <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Media Manager</span>
          </a>
      ...
      <div className="container justify-between items-center mx-auto dark:text-gray-200">

      <div className="p-1 mb-8 text-sm text-blue-700 bg-blue-100 dark:bg-blue-200 dark:text-blue-800" role="alert">
        <span className="font-medium">Welcome!</span> {jwt? jwt.username:"Guest"}
      </div>
